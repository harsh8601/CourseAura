    ...
    <Box padding={'4'} bg="blackAlpha.900" minH={'10vh'}>
      ...
      <Image src={logo} alt="Logo" boxSize="120px" />
        ...
        <VStack alignItems={['center', 'flex-start']} spacing="2">
          ...
          <Text color={'yellow.400'}>Nitin Singh</Text>
          <Text color={'yellow.400'}>7250130307</Text>
          <Text color={'yellow.400'}>harsharsh8601@gmail.com</Text>
          <Text color={'yellow.400'}>Naini, Prayagraj</Text>
        </VStack>
